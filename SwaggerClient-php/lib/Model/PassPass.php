 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PassPass implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'passPass';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_regular'] = isset($data['is_regular']) ? $data['is_regular'] : null;
    ...
    {
        return $this->container['is_regular'];
    }

    /**
     * Sets is_regular
     * @param bool $is_regular
     * @return $this
     */
    public function setIsRegular($is_regular)
    {
        $this->container['is_regular'] = $is_regular;
