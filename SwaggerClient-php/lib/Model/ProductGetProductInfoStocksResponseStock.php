...
/**
 * ProductGetProductInfoStocksResponseStock Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductGetProductInfoStocksResponseStock implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'productGetProductInfoStocksResponseStock';
    ...
    {
        $this->container['coming'] = isset($data['coming']) ? $data['coming'] : null;
