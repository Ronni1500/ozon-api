...
/**
 * PostingPostingFBSActCreateRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PostingPostingFBSActCreateRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'postingPostingFBSActCreateRequest';
    ...
    {
        $this->container['containers_count'] = isset($data['containers_count']) ? $data['containers_count'] : null;
